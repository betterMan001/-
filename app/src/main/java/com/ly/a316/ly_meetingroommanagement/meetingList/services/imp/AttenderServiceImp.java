...
public class AttenderServiceImp implements AttenderService {
    ...
    MeetingDetailActivity detailActivity;
    ...
    public AttenderServiceImp(MeetingDetailActivity detailActivity) {
        ...
        MyHttpUtil.sendOkhttpGetRequest(URL, new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                detailActivity.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        DisplayUtils.subThreadToast(detailActivity,Net.FAIL);
                        detailActivity.loadingDialog.dismiss();
                    }
                });
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    detailActivity.attenderListCallBack(list);
