 ...
 * 2019/1/22
 */
public class ShijiandianClass {


    public static String DATESTRING="";

    public static String HUIYISHICHANG_TIME="";
    public static String SHEBEI="";
    public static String HUIYI_WHERE="";
    ...
    public static int start_year,start_month,start_day,start_hour,start_miniute;
    public static int end_year,end_month,end_day,end_hour,end_miniute;
